## Updated 2021-05:04 12:35 PM/EDT
...
confirmed_raw <- read_csv("../COVID-19-John-Hopkins-Data/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_global.csv")
deaths_raw <- read_csv("../COVID-19-John-Hopkins-Data/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_deaths_global.csv")
recovered_raw <- read_csv("../COVID-19-John-Hopkins-Data/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_recovered_global.csv")
...
##
db <- dbConnect(SQLite(), dbname="../COVID-19-DB//JHU.sqlite3")
